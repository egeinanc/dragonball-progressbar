...
public enum Sprite {
    ...
    GOKU_KAMEHAMEHA_SMALL(3, new ImageIcon(DbzProgressBarUi.getResource("kamehameha.gif")), false, true, 0),
    GOKU_KAMEHAMEHA(4, new ImageIcon(DbzProgressBarUi.getResource("goku_kamehameha.gif")), false, false, 0),
